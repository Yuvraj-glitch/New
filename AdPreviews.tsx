import svgPaths from "./svg-zxtb9ifksy";
...
function Powered() {
  return (
    <div className="absolute bottom-5 content-stretch flex gap-2 items-start justify-center right-5 w-[178px]" data-name="Powered">
...
export default function AdPreviews() {
  return (
    <div className="bg-[#631adb] relative size-full" data-name="ad-previews">
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex gap-[120px] items-center justify-center p-[24px] relative size-full">
          <Ad1 />
          <Ad2 />
          <Ad3 />
          <Powered />
